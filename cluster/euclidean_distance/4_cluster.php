        ...
        <div class="col-md-1">
          <div class="table-responsive">
            <table class="table table-sm">
              ...
              <?php
                $query_update_init = $db->query("UPDATE tb_training SET C4DC1='0', C4DC2='0', C4DC3='0', C4DC4='0', C_before='', C_after='', hasil='0'");
                $S = 0;
                ...
                //   $K_C3 = rand(1,103);
                //   $K_C4 = rand(1,103);
                // } while ($K_C1 == $K_C2 && $K_C1 == $K_C3 && $K_C1 == $K_C4 && $K_C2 == $K_C3 && $K_C2 == $K_C4 && $K_C3 == $K_C4);
                $K_C1 = 1;
                $K_C2 = 2;
                $K_C3 = 3;
                $K_C4 = 4;
        ...
        <div class="col-md-3">
          <div class="table-responsive">
            <table class="table table-sm">
              <thead class="thead-dark">
                <tr>
                  <th colspan="4">Jarak Centroid</th>
                </tr>
                <tr>
                  <th>C1</th>
                  <th>C2</th>
                ...
                <?php
                  ...
                  while ($fetch_data = $query_data->fetch()) {
                    ...
                    $C4DC4 =
                      ...
                      if (min($C4DC1, $C4DC2, $C4DC3, $C4DC4) == $C4DC1) {
                        $C = 'C1';
                      } elseif (min($C4DC1, $C4DC2, $C4DC3, $C4DC4) == $C4DC2) {
                        $C = 'C2';
                      } elseif (min($C4DC1, $C4DC2, $C4DC3, $C4DC4) == $C4DC3) {
                        $C = 'C3';
                      } else {
                        $C = 'C4';
                      }
                      $query_update_C_before = $db->query("UPDATE tb_training SET C4DC1='$C4DC1', C4DC2='$C4DC2', C4DC3='$C4DC3', C4DC4='$C4DC4', C_before='$C' WHERE pelanggan='$fetch_data[0]'");
                      $cost_init_C4DC1 += $C4DC1;
                      $cost_init_C4DC2 += $C4DC2;
                      $cost_init_C4DC3 += $C4DC3;
                      $cost_init_C4DC4 += $C4DC4;
                      $cost_init_total = $cost_init_C4DC1 + $cost_init_C4DC2 + $cost_init_C4DC3 + $C4DC4;
                  }
                ?>
                <tr>
                  <td><?php echo number_format($cost_init_C4DC1, 3) ?></td>
                  <td><?php echo number_format($cost_init_C4DC2, 3) ?></td>
                  <td><?php echo number_format($cost_init_C4DC3, 3) ?></td>
                  <td><?php echo number_format($cost_init_C4DC4, 3) ?></td>
                </tr>
                <tr>
                  <th>Total Cost</th>
                  <th colspan="3"><?php echo number_format($cost_init_total, 3) ?></th>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="table table-sm">
              ...
              <?php
                do {
                  ...
                  // C1
                  $K_C1 == $K_C2 && $K_C1 == $K_C3 && $K_C1 == $K_C4 &&
                  $K_C1 == $Kn_C1 && $K_C1 == $Kn_C2 && $K_C1 == $Kn_C3 && $K_C1 == $Kn_C4 &&
                  // C2
                  $K_C2 == $K_C3 && $K_C2 == $K_C4 &&
                  $K_C2 == $Kn_C1 && $K_C2 == $Kn_C2 && $K_C2 == $Kn_C3 && $K_C2 == $Kn_C4 &&
                  // C3
                  $K_C3 == $K_C4 &&
                  $K_C3 == $Kn_C1 && $K_C3 == $Kn_C2 && $K_C3 == $Kn_C3 && $K_C3 == $Kn_C4 &&
                  // C4
                  $K_C4 == $Kn_C1 && $K_C4 == $Kn_C2 && $K_C4 == $Kn_C3 && $K_C4 == $Kn_C4 &&
                  // New C1
                  $Kn_C1 == $Kn_C2 && $Kn_C1 == $Kn_C3 && $Kn_C1 == $Kn_C4 &&
                  // New C2
                  $Kn_C2 == $Kn_C3 &&  $Kn_C2 == $Kn_C4 &&
                  // New C3
                  $Kn_C3 == $Kn_C4);
              ?>
              <tbody>
          ...
          <div class="table-responsive">
            <table class="table table-sm">
              ...
              <tbody>
                <?php
                  ...
                  while ($fetch_data = $query_data->fetch()) {
                    ...
                    $C4DC4 =
                      ...
                      $query_update_C_before = $db->query("UPDATE tb_training SET C4DC1='$C4DC1', C4DC2='$C4DC2', C4DC3='$C4DC3', C4DC4='$C4DC4', C_after='$C' WHERE pelanggan='$fetch_data[0]'");
                      $cost_new_C4DC1 += $C4DC1;
                      $cost_new_C4DC2 += $C4DC2;
                      $cost_new_C4DC3 += $C4DC3;
                      $cost_new_C4DC4 += $C4DC4;
                      $cost_new_total = $cost_new_C4DC1 + $cost_new_C4DC2 + $cost_new_C4DC3 + $cost_new_C4DC4;
                  }
                ...
                ?>
                <tr>
                  <td><?php echo number_format($cost_new_C4DC1, 3) ?></td>
                  <td><?php echo number_format($cost_new_C4DC2, 3) ?></td>
                  <td><?php echo number_format($cost_new_C4DC3, 3) ?></td>
                  <td><?php echo number_format($cost_new_C4DC4, 3) ?></td>
                </tr>
                <tr>
                  <th>Total Cost</th>
        ...
        <div class="col-md-2">
          ...
          <div class="table-responsive">
            <table class="table table-sm">
              <thead class="thead-dark">
                <tr>
                  <th colspan="4">Anggota Cluster</th>
                </tr>
                <tr>
                  <th>C1</th>
                  <th>C2</th>
