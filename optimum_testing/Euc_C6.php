  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-4">
          <div class="table-responsive">
            <table class="table table-sm">
              ...
              <?php
                $query = $db->query("SELECT C6DC1, C6DC2, C6DC3, C6DC4, C6DC5, C6DC6 FROM tb_training");
                $DC1_max = 0;
                $DC2_max = 0;
                $DC3_max = 0;
                $DC4_max = 0;
      ...
      <?php
        ...
        $query = $db->query("SELECT Daya_WBP_1, Daya_WBP_2, Daya_WBP_3, Daya_WBP_4, Daya_WBP_5, Daya_WBP_6, Daya_WBP_7 FROM tb_centroid WHERE cluster = '6' AND C='C2'");
        $data_centroid_WBP_C2 = $query->fetch();
        $query = $db->query("SELECT Daya_LWBP_1, Daya_LWBP_2, Daya_LWBP_3, Daya_LWBP_4, Daya_LWBP_5, Daya_LWBP_6, Daya_LWBP_7 FROM tb_centroid WHERE cluster = '6' AND C='C2'");
        $data_centroid_LWBP_C2 = $query->fetch();

        $query = $db->query("SELECT Daya_WBP_1, Daya_WBP_2, Daya_WBP_3, Daya_WBP_4, Daya_WBP_5, Daya_WBP_6, Daya_WBP_7 FROM tb_centroid WHERE cluster = '6' AND C='C3'");
        $data_centroid_WBP_C3 = $query->fetch();
        $query = $db->query("SELECT Daya_LWBP_1, Daya_LWBP_2, Daya_LWBP_3, Daya_LWBP_4, Daya_LWBP_5, Daya_LWBP_6, Daya_LWBP_7 FROM tb_centroid WHERE cluster = '6' AND C='C3'");
        $data_centroid_LWBP_C3 = $query->fetch();

        $query = $db->query("SELECT Daya_WBP_1, Daya_WBP_2, Daya_WBP_3, Daya_WBP_4, Daya_WBP_5, Daya_WBP_6, Daya_WBP_7 FROM tb_centroid WHERE cluster = '6' AND C='C4'");
        $data_centroid_WBP_C4 = $query->fetch();
        $query = $db->query("SELECT Daya_LWBP_1, Daya_LWBP_2, Daya_LWBP_3, Daya_LWBP_4, Daya_LWBP_5, Daya_LWBP_6, Daya_LWBP_7 FROM tb_centroid WHERE cluster = '6' AND C='C4'");
        $data_centroid_LWBP_C4 = $query->fetch();

        $query = $db->query("SELECT Daya_WBP_1, Daya_WBP_2, Daya_WBP_3, Daya_WBP_4, Daya_WBP_5, Daya_WBP_6, Daya_WBP_7 FROM tb_centroid WHERE cluster = '6' AND C='C5'");
        $data_centroid_WBP_C5 = $query->fetch();
        $query = $db->query("SELECT Daya_LWBP_1, Daya_LWBP_2, Daya_LWBP_3, Daya_LWBP_4, Daya_LWBP_5, Daya_LWBP_6, Daya_LWBP_7 FROM tb_centroid WHERE cluster = '6' AND C='C5'");
        $data_centroid_LWBP_C5 = $query->fetch();

        $query = $db->query("SELECT Daya_WBP_1, Daya_WBP_2, Daya_WBP_3, Daya_WBP_4, Daya_WBP_5, Daya_WBP_6, Daya_WBP_7 FROM tb_centroid WHERE cluster = '6' AND C='C6'");
        $data_centroid_WBP_C6 = $query->fetch();
        $query = $db->query("SELECT Daya_LWBP_1, Daya_LWBP_2, Daya_LWBP_3, Daya_LWBP_4, Daya_LWBP_5, Daya_LWBP_6, Daya_LWBP_7 FROM tb_centroid WHERE cluster = '6' AND C='C6'");
        $data_centroid_LWBP_C6 = $query->fetch();
        ...
        while ($fetch_data = $query->fetch()) {
          ...
          $DC6 =
            sqrt(
              pow($fetch_data[1]-$data_centroid_WBP_C6[0], 2) + pow($fetch_data[2]-$data_centroid_LWBP_C6[0], 2)+
              pow($fetch_data[3]-$data_centroid_WBP_C6[1], 2) + pow($fetch_data[4]-$data_centroid_LWBP_C6[1], 2)+
              pow($fetch_data[5]-$data_centroid_WBP_C6[2], 2) + pow($fetch_data[6]-$data_centroid_LWBP_C6[2], 2)+
              pow($fetch_data[7]-$data_centroid_WBP_C6[3], 2) + pow($fetch_data[8]-$data_centroid_LWBP_C6[3], 2)+
              pow($fetch_data[9]-$data_centroid_WBP_C6[4], 2) + pow($fetch_data[10]-$data_centroid_LWBP_C6[4], 2)+
              pow($fetch_data[11]-$data_centroid_WBP_C6[5], 2) + pow($fetch_data[12]-$data_centroid_LWBP_C6[5], 2)+
              pow($fetch_data[13]-$data_centroid_WBP_C6[6], 2) + pow($fetch_data[14]-$data_centroid_LWBP_C6[6], 2)
            );
        }
      ?>
        <div class="col-md-4">
            ...
            <table class="table table-sm">
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo number_format($DC6, 3) ?></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div class="col-md-4">
          <?php if ($DC1 > $DC1_max || $DC2 > $DC2_max || $DC3 > $DC3_max || $DC4 > $DC4_max || $DC5 > $DC5_max || $DC6 > $DC6_max) { ?>
            ...
            data: {
                datasets: [{
                    ...
                    data: [{
                        ...
                        x: 7,
                        y: <?php echo number_format($DC6_max, 3); ?>
                    }]
                },{
                    label: 'DC Testing',
                    borderColor: "red",
                    data: [{
                        ...
                        x: 7,
                        y: <?php echo number_format($DC6, 3); ?>
                    }]
                }]
            },
            options: {
