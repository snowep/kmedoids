...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <?php
        $query = $db->query("SELECT Daya_WBP_1, Daya_WBP_2, Daya_WBP_3, Daya_WBP_4, Daya_WBP_5, Daya_WBP_6, Daya_WBP_7 FROM tb_centroid WHERE cluster = '2' AND C='C1'");
        $data_centroid_WBP_C1 = $query->fetch();
        $query = $db->query("SELECT Daya_LWBP_1, Daya_LWBP_2, Daya_LWBP_3, Daya_LWBP_4, Daya_LWBP_5, Daya_LWBP_6, Daya_LWBP_7 FROM tb_centroid WHERE cluster = '2' AND C='C1'");
        $data_centroid_LWBP_C1 = $query->fetch();

        $query = $db->query("SELECT Daya_WBP_1, Daya_WBP_2, Daya_WBP_3, Daya_WBP_4, Daya_WBP_5, Daya_WBP_6, Daya_WBP_7 FROM tb_centroid WHERE cluster = '2' AND C='C2'");
        $data_centroid_WBP_C2 = $query->fetch();
        $query = $db->query("SELECT Daya_LWBP_1, Daya_LWBP_2, Daya_LWBP_3, Daya_LWBP_4, Daya_LWBP_5, Daya_LWBP_6, Daya_LWBP_7 FROM tb_centroid WHERE cluster = '2' AND C='C2'");
      ...
      ?>
        ...
        <div class="col-md-4">
          <?php if ($DC1 > $DC1_max || $DC2 > $DC2_max) { ?>
